angular.module('wlan')
    ...
    .controller("listContronller", ['$scope', '$modalInstance','$translate', 'InterService', 'authentifiedRequest', 'batchSyncConfig', 'toastr', 'wlans', 'hanCrypto', function($scope, $modalInstance,$translate, InterService, authentifiedRequest, batchSyncConfig, toastr, wlans, hanCrypto) {
        //define skin
        ...
        $scope.editWlan = function() {
            ...
            if($scope.currentWlan.securityType == "Personal"){
